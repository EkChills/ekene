...
import { cn, firstProject, r1, r2, r3, secondProject, thirdProject } from "@/lib/utils";
    ...
    <MotionDiv {...anim(trans)} className="px-4 sm:px-6 pt-4 min-h-screen bg-[#A6A6A6] pb-6">
      <MaxWidthWrapper>
        ...
        >
          ...
          <div className="flex flex-col mt-4">
            <div className="flex justify-between">
              <Link href={'https://github.com/EkChills'} target="_blank" className="flex items-center gap-1">
                <h1 className="uppercase text-base md:text-lg font-semibold">
                  Github
                </h1>
                <ExternalLink className="w-4 h-4" />
              </Link>
              <Link href={'https://www.linkedin.com/in/ekene-ezeifeoma-a9395b241/'} target="_blank" className="flex items-center gap-1">
                <h1 className="uppercase text-base md:text-lg font-semibold">
                  Linkedin
                </h1>
                <ExternalLink className="w-4 h-4" />
        ...
        <section className="antialiased mt-16">
          ...
          <p className="text-base  font-medium">
            ...
            area of expertise is creating completely functioning, optimized, and
            visually appealing websites that skillfully use the newest
            technology to address practical issues. I am always driven to learn
            and become proficient in new technologies by the exciting and
            ever-changing field of web development. My commitment is in
            developing innovative and sophisticated digital experiences that go
            beyond basic usability to produce solutions that have a real-world
            impact.
          </p>
        </section>
        <section className="antialiased mt-16 ">
        ...
        <section className="antialiased mt-16">
          ...
          <div>
            ...
            <p className=" text-base font-medium">
            Surveyy is an automated survey generator web application leveraging OpenAI for the machine learning capability. This project demonstrated my abilities designing and deploying full-stack apps using modern technologies.
            The goal was to create a flexible survey platform where users can instantly generate custom survey questionnaires tailored to their data collection needs.
            </p>
          ...
          <div>
            ...
            <p className=" text-base font-medium">
            VibeChat is a multi-user chat platform allowing users to communicate in real-time via public and private chat rooms. I implemented this using Next.js for its serverless capabilities along with incorporating the Pusher API for enabling the seamless real-time data streams.
            The app allows creating an account, starting conversations with individuals or groups and seamless real-time messaging powered by Pusher Channels. Core functionality was built around React Hooks with serverless functions connecting to a superbases postgress database and authentication via NextAuth.js.
            </p>
            <div className="flex gap-4 mt-2">
              <Link
          ...
          <div>
            ...
            <p className=" text-base font-medium">
            Damnify is a conversational Ai tool that can provide intelligent responses to user questions. This system leverages text generation models from OpenAI to power an engaging question answering experience.
            The website interface allows visitors to ask the AI assistant open-ended questions on any topic just as they would chat with a person.
            </p>
            <div className="flex gap-4 mt-2">
              <Link
